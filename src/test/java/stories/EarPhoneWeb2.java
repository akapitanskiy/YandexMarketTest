...
public class EarPhoneWeb2 {
  ...
  @Test
  public void testEarPhoneWeb2() throws Exception {
    driver.get(baseUrl + "/catalog/54440?hid=198119&track=menu");
    driver.findElement(By.xpath("(//a[contains(text(),'Наушники и Bluetooth-гарнитуры')])[2]")).click();
